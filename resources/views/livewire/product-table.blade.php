                  ...
                  @foreach ($products as $product)
                    <tr wire:key="{{ $product->id }}">
                        ...
                        <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                          <a wire:navigate href="">
                            <div class="flex items-center gap-x-3">
                              ...
                              <div class="grow">
                                <span
                                  class="block text-sm font-semibold text-gray-800">{{ str($product->name)->words(3) }}</span>
                              </div>
                            </div>
                          </a>
                      ...
                      <td class="size-px whitespace-nowrap">
                        <div class="px-6 py-3">
                          <span
                            class="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs font-medium text-teal-800 rounded-full">
                      ...
                      <td class="size-px whitespace-nowrap">
                        <div class="px-6 py-3">
                          <span
                            class="text-sm text-gray-500 500">{{ date('D M Y, H:i', strtotime($product->created_at)) }}</span>
                        </div>
                      </td>
                      <td class="size-px whitespace-nowrap">
